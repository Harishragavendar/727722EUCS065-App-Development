    ...
    >
      <div className="container">
        <div className="front fp-w fp-fh fp-h" style={{ minHeight: '250px', height: '260px', width: '350px' }}>
          <img
            src="https://cdnc.heyzine.com/flip-book/cover/5ca379d190.jpg"
        ...
        <div className="back fp-w fp-fh fp-h" style={{ minHeight: '250px', height: '260px', width: '350px' }}>
          ...
          <div className="inner">
            <p>
              ...
              <br />
              <a href="https://heyzine.com/flip-book/5ca379d190.html" rel="noopener noreferrer" className="fp-link">
                View
              </a>
            </p>
          </div>
